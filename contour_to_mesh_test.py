"""
see https://github.com/SimVascular/SimVascular-Tests/tree/master/new-api-tests

Takes in segmentation file (XXX.ctgr)
Allows for programmatic manipulation of contour control points
Creates files for svpre operation
...
def main():
    ...
    contours[expand_id]=manipulate_contour(contours[expand_id],scale_factor=expand_factor)
